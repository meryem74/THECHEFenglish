...
class Restaurant(db.Model):
    ...
    # İlişkiler: cascade eklendi
    menus = db.relationship('Menu', backref='restaurant', lazy=True, cascade="all, delete-orphan")
    comments = db.relationship('Comment', backref='restaurant', lazy=True, cascade="all, delete-orphan")
...
class Menu(db.Model):
    ...
    # İlişkiler: cascade ile OrderItem silinir
